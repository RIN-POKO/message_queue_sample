...
#define CONFIG_SYSTEM_TASKSET 1
#define CONFIG_SYSTEM_TASKSET_PROGNAME "taskset"
#define CONFIG_SYSTEM_TASKSET_PRIORITY 50
#define CONFIG_SYSTEM_TASKSET_STACKSIZE 2048
